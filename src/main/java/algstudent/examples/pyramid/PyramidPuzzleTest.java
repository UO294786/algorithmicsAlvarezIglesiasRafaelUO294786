package algstudent.examples.pyramid;
...
public class PyramidPuzzleTest {
	@Test
	public void test5() {
		boolean result = executeFromFile("src/main/java/algstudent/examples/pyramid/case5.txt");
		assertEquals(true, result);
	}
	
	@Test
	public void test15() {
		boolean result = executeFromFile("src/main/java/algstudent/examples/pyramid/case15.txt");
		assertEquals(true, result);
	}
